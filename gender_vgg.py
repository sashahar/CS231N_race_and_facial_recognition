...
def save_checkpoint(state,is_best,file_name = 'vgg_checkpoint_v4.pth.tar'):
	torch.save(state,file_name)
	if is_best:
        print("saving best model best model")
		shutil.copyfile(file_name,'vgg_model_best_v4.pth.tar')
    else:
...
def train_model(vgg16, criterion, optimizer, scheduler, num_epochs=2):
    best_val_acc = 0.0
    ...
    for epoch in range(num_epochs):
        ...
        for labels, race_labels, img_names, images in train_loader:
